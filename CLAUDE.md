...
- When making updates, always modify the CLI source code, then run `npm run dev init -- --force --pack frontend-react` to update our own dogfooding setup
...
- **.zcc/config**: Project config (like .zshrc)
